...
func init() {
	fmt.Printf("// size of distinctBoolOp is %d\n", unsafe.Sizeof(distinctBoolOp{}))
	fmt.Printf("// size of distinctBytesOp is %d\n", unsafe.Sizeof(distinctBytesOp{}))
	fmt.Printf("// size of distinctDecimalOp is %d\n", unsafe.Sizeof(distinctDecimalOp{}))
	fmt.Printf("// size of distinctInt16Op is %d\n", unsafe.Sizeof(distinctInt16Op{}))
	fmt.Printf("// size of distinctInt32Op is %d\n", unsafe.Sizeof(distinctInt32Op{}))
	fmt.Printf("// size of distinctInt64Op is %d\n", unsafe.Sizeof(distinctInt64Op{}))
	fmt.Printf("// size of distinctFloat64Op is %d\n", unsafe.Sizeof(distinctFloat64Op{}))
	fmt.Printf("// size of distinctTimestampOp is %d\n", unsafe.Sizeof(distinctTimestampOp{}))
	fmt.Printf("// size of distinctIntervalOp is %d\n", unsafe.Sizeof(distinctIntervalOp{}))
	fmt.Printf("// size of distinctDatumOp is %d\n", unsafe.Sizeof(distinctDatumOp{}))
}
