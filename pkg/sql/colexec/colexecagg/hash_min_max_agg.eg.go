...
func init() {
	fmt.Printf("// size of minBoolHashAgg is %d\n", sizeOfminBoolHashAgg)
	fmt.Printf("// size of minBytesHashAgg is %d\n", sizeOfminBytesHashAgg)
	fmt.Printf("// size of minDecimalHashAgg is %d\n", sizeOfminDecimalHashAgg)
	fmt.Printf("// size of minInt16HashAgg is %d\n", sizeOfminInt16HashAgg)
	fmt.Printf("// size of minInt32HashAgg is %d\n", sizeOfminInt32HashAgg)
	fmt.Printf("// size of minInt64HashAgg is %d\n", sizeOfminInt64HashAgg)
	fmt.Printf("// size of minFloat64HashAgg is %d\n", sizeOfminFloat64HashAgg)
	fmt.Printf("// size of minTimestampHashAgg is %d\n", sizeOfminTimestampHashAgg)
	fmt.Printf("// size of minIntervalHashAgg is %d\n", sizeOfminIntervalHashAgg)
	fmt.Printf("// size of minDatumHashAgg is %d\n", sizeOfminDatumHashAgg)
	fmt.Printf("// size of maxBoolHashAgg is %d\n", sizeOfmaxBoolHashAgg)
	fmt.Printf("// size of maxBytesHashAgg is %d\n", sizeOfmaxBytesHashAgg)
	fmt.Printf("// size of maxDecimalHashAgg is %d\n", sizeOfmaxDecimalHashAgg)
	fmt.Printf("// size of maxInt16HashAgg is %d\n", sizeOfmaxInt16HashAgg)
	fmt.Printf("// size of maxInt32HashAgg is %d\n", sizeOfmaxInt32HashAgg)
	fmt.Printf("// size of maxInt64HashAgg is %d\n", sizeOfmaxInt64HashAgg)
	fmt.Printf("// size of maxFloat64HashAgg is %d\n", sizeOfmaxFloat64HashAgg)
	fmt.Printf("// size of maxTimestampHashAgg is %d\n", sizeOfmaxTimestampHashAgg)
	fmt.Printf("// size of maxIntervalHashAgg is %d\n", sizeOfmaxIntervalHashAgg)
	fmt.Printf("// size of maxDatumHashAgg is %d\n", sizeOfmaxDatumHashAgg)
}
