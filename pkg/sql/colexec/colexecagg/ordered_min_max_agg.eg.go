...
func init() {
	fmt.Printf("// size of minBoolOrderedAgg is %d\n", sizeOfminBoolOrderedAgg)
	fmt.Printf("// size of minBytesOrderedAgg is %d\n", sizeOfminBytesOrderedAgg)
	fmt.Printf("// size of minDecimalOrderedAgg is %d\n", sizeOfminDecimalOrderedAgg)
	fmt.Printf("// size of minInt16OrderedAgg is %d\n", sizeOfminInt16OrderedAgg)
	fmt.Printf("// size of minInt32OrderedAgg is %d\n", sizeOfminInt32OrderedAgg)
	fmt.Printf("// size of minInt64OrderedAgg is %d\n", sizeOfminInt64OrderedAgg)
	fmt.Printf("// size of minFloat64OrderedAgg is %d\n", sizeOfminFloat64OrderedAgg)
	fmt.Printf("// size of minTimestampOrderedAgg is %d\n", sizeOfminTimestampOrderedAgg)
	fmt.Printf("// size of minIntervalOrderedAgg is %d\n", sizeOfminIntervalOrderedAgg)
	fmt.Printf("// size of minDatumOrderedAgg is %d\n", sizeOfminDatumOrderedAgg)
	fmt.Printf("// size of maxBoolOrderedAgg is %d\n", sizeOfmaxBoolOrderedAgg)
	fmt.Printf("// size of maxBytesOrderedAgg is %d\n", sizeOfmaxBytesOrderedAgg)
	fmt.Printf("// size of maxDecimalOrderedAgg is %d\n", sizeOfmaxDecimalOrderedAgg)
	fmt.Printf("// size of maxInt16OrderedAgg is %d\n", sizeOfmaxInt16OrderedAgg)
	fmt.Printf("// size of maxInt32OrderedAgg is %d\n", sizeOfmaxInt32OrderedAgg)
	fmt.Printf("// size of maxInt64OrderedAgg is %d\n", sizeOfmaxInt64OrderedAgg)
	fmt.Printf("// size of maxFloat64OrderedAgg is %d\n", sizeOfmaxFloat64OrderedAgg)
	fmt.Printf("// size of maxTimestampOrderedAgg is %d\n", sizeOfmaxTimestampOrderedAgg)
	fmt.Printf("// size of maxIntervalOrderedAgg is %d\n", sizeOfmaxIntervalOrderedAgg)
	fmt.Printf("// size of maxDatumOrderedAgg is %d\n", sizeOfmaxDatumOrderedAgg)
}
